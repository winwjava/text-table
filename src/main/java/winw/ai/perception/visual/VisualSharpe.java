 ...
 *
 */
public class VisualSharpe extends Graph {// 需要支持三维形状
...
//	private SimpleMatrix matrix = new SimpleMatrix(210, 210);// 形状矩阵
	...
	public VisualSharpe(List<Point> edge) {
...
//		System.out.println(matrix);
	 ...
	 * 判断是否是人脸形状，然后判断是谁。
	 */
	public double match(VisualSharpe other) {// 用平方差，相关系数等
		return 0;
	}
...
//		dstMat
	 ...
	 * @return
	 */
	public double similar(VisualSharpe other) {
//		在算法相似度量中又有以下几种计算方法：
//		1、同现相似度
//		2、欧式距离相似度
//		3、余弦相似度
