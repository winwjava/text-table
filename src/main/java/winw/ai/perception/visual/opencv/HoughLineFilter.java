...
public class HoughLineFilter extends AbstractBufferedImageOp {
	...
	public static void main(String[] args) throws IOException {
		...
		BufferedImage bufferedImage = ImageIO.read(new File("D:/file/05-StereoVision.jpg"));
		long t0 = System.currentTimeMillis();

		HoughLineFilter houghLine = new HoughLineFilter();
		BufferedImage result = houghLine.filter(bufferedImage, ImageIO.read(new File("D:/file/05-StereoVision.jpg")));

		long t1 = System.currentTimeMillis();
		System.out.println("HoughLineFilter, cost: " + (t1 - t0) + "ms.");
		FileOutputStream output = new FileOutputStream(new File("D:/file/0502-hough.jpg"));
