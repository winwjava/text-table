...
class SURFFLANNMatching {
	...
	public void run(String[] args) {
		String filename1 = args.length > 1 ? args[0] : "E:\\opencv-4.x\\samples\\data\\box.png";
		String filename2 = args.length > 1 ? args[1] : "E:\\opencv-4.x\\samples\\data\\box_in_scene.png";
