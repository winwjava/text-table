...
<img width="400px" src="./docs/DQN.png">
...
依靠大脑的“愉悦”功能，将走马灯一样的短时记忆，强化为认知经验。以操作性条件反射为例，如下图：

<img width="auto" src="./docs/operant-conditioning.jpg">

尝试拧瓶盖成功后，喝到饮料会触发愉悦奖赏机制，强化了记忆。
